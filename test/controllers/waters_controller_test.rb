...
class WatersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create water" do
    assert_difference('Water.count') do
      post waters_url, params: { water: { address: @water.address, customer_id: @water.customer_id } }, as: :json
    end
  ...
  test "should update water" do
    patch water_url(@water), params: { water: { address: @water.address, customer_id: @water.customer_id } }, as: :json
    assert_response 200
  end
